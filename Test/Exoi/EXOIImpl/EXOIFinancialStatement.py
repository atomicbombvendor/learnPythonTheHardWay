...
class EXOIFinancialStatement(AbstractEXOI):

    def __init__(self):
        AbstractEXOI.__init__(self)
        self.value_mapping = {
            #region FinanicalIncomeStatementsDataPoint
            ...
            #region
            20435: 'TotalOperatingIncomeAsReported',
            20436: 'OtherGandA',
            20437: 'OtherCostofRevenue',
            20438: 'RentandLandingFeesCostofRevenue',
            20439: 'DDACostofRevenue',
            20440: 'RentExpenseSupplemental',
            ...
            23309: 'InvestmentsInAffiliatesSubsidiariesAssociatesAndJointVenture',
            ...
            23552: 'RevaluationReserve',
            23553: 'CurrentOtherFinancialLiabilities',
            23554: 'NonCurrentOtherFinancialLiabilities',
            23555: 'OtherFinancialLiabilities',
            26000: 'Amortization',
            ...
            26244: 'CashReceiptsfromRepaymentofAdvancesandLoansMadetoOtherPartie',
            ...
            26300: 'NetInvestmentPropertiesPurchaseAndSale',
            26301: 'PurchaseOfInvestmentProperties',
            26302: 'SaleOfInvestmentProperties',
            26303: 'OtherCashAdjustIncludedIntoChangeinCash',
            26304: 'OtherCashAdjustExcludeFromChangeinCash',
    ...
    def get_node_type(self, values, value_set):
        ...
        if self.IncomeStatement_mapping.get(dataId):
            ...
            values['targetNode'] = self.IncomeStatement_mapping.get(int(value_set[1]))  # DataId对应的节点的名字
